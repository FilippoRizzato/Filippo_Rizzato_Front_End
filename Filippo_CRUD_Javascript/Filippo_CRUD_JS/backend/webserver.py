...
class WebRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path == '/products':
            ...
            for i, tup in enumerate(product):
                d["data"].append({"type": "products", "id": tup[0], "attributes": {"marca": tup[2], "nome": tup[1], "prezzo": tup[3]}})
    ...
    def do_POST(self):
        if self.path == '/products':
            ...
            marca = data["data"][0]["attributes"]['marca']
            nome = data["data"][0]["attributes"]['nome']
            prezzo = data["data"][0]["attributes"]['prezzo']
